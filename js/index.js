...
//#3 Дан взвешенный неориентированный связный граф с n вершинами, пронумерованными от 0до n - 1, и массив edges где представляет двунаправленное и взвешенное ребро между узлами   и . Минимальное остовное дерево (MST) — это подмножество ребер графа, соединяющее все вершины без циклов и с минимально возможным общим весом ребер.edges[i] = [ai, bi, weighti]aibi

// Найдите все критические и псевдокритические ребра в минимальном остовном дереве (MST) данного графа . Ребро MST, удаление которого из графа приведет к увеличению веса MST, называется  критическим ребром . С другой стороны, псевдокритическим преимуществом является то, что может появиться в некоторых MST, но не во всех.
